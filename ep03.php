...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>RAZ:: Episode 3 - French TV </title>
    ...
    <body>
        <div id="container">
            ...
            <div class="content">
                <div id="video">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/VSWMUS6vScA" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                </div>
