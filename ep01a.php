...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>RAZ:: Episode 1 - Operation Treehouse pt.1 </title>
    ...
    <body>
        ...
        <div class="content">
            <div id="video">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/7COFtGGDaCA" allow="autoplay; encrypted-media" allowfullscreen></iframe>
            </div>
         <br id="space">
